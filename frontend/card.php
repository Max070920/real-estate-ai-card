...
// テックツール取得
$stmt = $db->prepare("SELECT tool_type, tool_name, tool_url FROM tech_tool_selections WHERE business_card_id = ? AND is_active = 1 ORDER BY display_order ASC");
$stmt->execute([$card['id']]);
    ...
    <div class="card-container">
        ...
        <section class="card-section">
            <div class="card-header">
                ...
                <img src="<?php echo htmlspecialchars(BASE_URL . '/' . $card['company_logo']); ?>" alt="ロゴ" class="company-logo">
                <?php endif; ?>
            ...
            <div class="card-body">
                ...
                <img src="<?php echo htmlspecialchars(BASE_URL . '/' . $card['profile_photo']); ?>" alt="プロフィール写真" class="profile-photo">
                <?php endif; ?>
