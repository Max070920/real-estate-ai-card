...
# データベース作成
CREATE DATABASE real_estate_card CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

# スキーマのインポート
mysql -u root -p real_estate_card < backend/database/schema.sql
```

またはphpMyAdminを使用:
1. phpMyAdminにアクセス (http://localhost/phpmyadmin)
2. 新しいデータベース `real_estate_card` を作成
